...
Shader "Water"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 lerpResult68 = lerp( tex2D( _NormalMap, UV193 ) , float4( UnpackScaleNormal( tex2D( _NormalMap, UV2101 ), ( _NormalMapStrenght2 * depthFade137 ) ) , 0.0 ) , _LerpStrenght);
			...
			Unity_GlossyEnvironmentData g133 = UnityGlossyEnvironmentSetup( 1.0, data.worldViewDir, indirectNormal133, float3(0,0,0));
			...
			float4 lerpResult111 = lerp( screenColor62 , ( float4( indirectSpecular133 , 0.0 ) + _Tint ) , ( Fresnel122 * depthFade137 * cameraDepthFade145 ));
			c.rgb = lerpResult111.rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18500
-1024;-72;1024;1219;3030.795;1996.183;3.775963;False;False
...
Node;AmplifyShaderEditor.Vector4Node;86;-4031.613,465.3134;Inherit;False;Property;_AnimetUV1XYUV2ZW;Animet UV1 (XY) UV2(ZW);2;0;Create;True;0;0;False;0;False;0,0,0,0;10,10,10,10;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector4Node;102;-3789.027,788.8256;Inherit;False;Property;_UV2TilingXYScaleZW;UV2 Tiling(XY) Scale(ZW);4;0;Create;True;0;0;False;0;False;0,0,0,0;1,1,5,5;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector4Node;89;-3618.274,-152.9209;Inherit;False;Property;_UV1TilingXYScaleZW;UV1 Tiling(XY) Scale(ZW);3;0;Create;True;0;0;False;0;False;0,0,0,0;1,1,10,10;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;138;-2096.037,-777.028;Inherit;False;Property;_DepthFadeDistance;Depth Fade Distance;9;0;Create;True;0;0;False;0;False;0;0.52;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;73;-2461.492,389.3475;Inherit;False;1356.13;612.1998;Normal Mapping;12;70;68;64;63;69;108;107;109;110;150;151;149;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;151;-2373.056,885.3571;Inherit;False;137;depthFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;110;-2438.736,765.1152;Inherit;False;Property;_NormalMapStrenght2;Normal Map Strenght 2;6;0;Create;True;0;0;False;0;False;0;0.85;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;149;-2140.584,791.5999;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;107;-2216.199,438.002;Inherit;False;93;UV1;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;108;-2206.416,674.9812;Inherit;False;101;UV2;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;63;-1957.002,439.3475;Inherit;True;Property;_NormalMap;Normal Map;0;0;Create;True;0;0;False;0;False;-1;fffede64080df434ca75789e38e09e2a;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;69;-1933.17,875.3561;Inherit;False;Property;_LerpStrenght;Lerp Strenght;1;0;Create;True;0;0;False;0;False;0;0.282;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;70;-1333.363,625.054;Inherit;False;normalMapping;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-2234.078,-987.9872;Inherit;False;Property;_CameraDepthFadeOffset;Camera Depth Fade Offset;11;0;Create;True;0;0;False;0;False;0;0.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2252.078,-1072.987;Inherit;False;Property;_CameraDepthFadeLength;Camera Depth Fade Length;10;0;Create;True;0;0;False;0;False;0;0.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;121;-1828.595,-409.367;Inherit;False;Property;_FresnelPower;Fresnel Power;7;0;Create;True;0;0;False;0;False;0;1;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;147;-821.7719,764.7745;Inherit;False;145;cameraDepthFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.IndirectSpecularLight;133;-778.3481,196.322;Inherit;False;Tangent;3;0;FLOAT3;0,0,1;False;1;FLOAT;1;False;2;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;77;-773.2848,44.71783;Inherit;False;71;screenUV;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;124;-785.2083,601.6207;Inherit;False;122;Fresnel;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;113;-829.1047,383.1192;Inherit;False;Property;_Tint;Tint;8;0;Create;True;0;0;False;0;False;0,0,0,0;0.3685029,0.8584906,0.8209507,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;141;-785.7217,683.9922;Inherit;False;137;depthFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;-530.1579,606.538;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;135;-466.0141,265.4479;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ScreenColorNode;62;-544.5513,2.583523;Inherit;False;Global;_GrabScreen0;Grab Screen 0;0;0;Create;True;0;0;False;0;False;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;111;-257.1802,254.4549;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;109;-2441.985,517.37;Inherit;False;Property;_NormalMapStrenght1;Normal Map Strenght 1;5;0;Create;True;0;0;False;0;False;0;0.23;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;150;-2133.584,535.5997;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=E2EDAEDB8C5CBF0B46E157C9441B714CA9D841E9